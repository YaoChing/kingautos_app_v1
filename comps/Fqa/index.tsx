  ...
  return (
    <View
      ...
      <View 
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text
                style={{fontSize: 18, color: '#ffffff'}}>新車選購</Text>
            </View>
          </View>
          <View
            style={{flex: 0.35, padding: 10, alignItems: 'flex-end', justifyContent: 'center'}}>
            <Text
              style={{fontSize: 14, color: '#c2c2c2'}}>2019/11/08</Text>
            <View
        ...
        <View
          style={{flex: 0.4, marginHorizontal: 10, borderBottomWidth: 1, borderBottomColor: '#c2c2c2', justifyContent: 'center', alignItems: 'center'}}>
          <Text
            numberOfLines={2}
            style={{fontSize: 18, lineHeight: 22, fontWeight: 'bold', color: '#222222'}}>問題標題問題標題問題標題問題標題問題標題問題標題問題標題問題標題問題標題問題標題</Text>
        </View>
        <View
          ...
          <View style={{flex: 0.4, flexDirection: 'row', alignItems: 'center'}}>
            ...
            <View
              ...
              <Text
                style={{color: '#b71d29', fontSize: 15}}>狐狸</Text>
            </View>
            <Text>提問</Text>
          </View>
          <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
            <Text
              numberOfLines={3}
              style={{fontSize: 18, lineHeight: 22}} ></Text>
          </View>
          <View style={{flex: 0.4, flexDirection: 'row', alignItems: 'center'}}>
